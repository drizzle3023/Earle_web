...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <meta name="description" content="Earle Project">
                ...
                <div class="bg-header-dark">
                    <div class="content-header bg-white-10">
                        ...
                        <a class="link-fx font-w600 font-size-lg text-white" href="/">
                            <span class="text-white">Earle</span>
                        </a>
                        <!-- END Logo -->
...
{{--                                <span class="nav-main-link-badge badge badge-pill badge-success">5</span>--}}
                        ...
                        <li class="nav-main-item open">
                            <a class="nav-main-link{{ request()->is('user*') ? ' active' : '' }}" href="{{asset('/user')}}">
                        ...
                        <li class="nav-main-item open">
                            <a class="nav-main-link{{ request()->is('company*') ? ' active' : '' }}" href="{{asset('/company')}}">
                                <i class="nav-main-link-icon far fa-building"></i>
                                <span class="nav-main-link-name">Company</span>
                            </a>
                        </li>
                        <li class="nav-main-item open">
                            <a class="nav-main-link{{ request()->is('jobnumber*') ? ' active' : '' }}" href="{{asset('/jobnumber')}}">
                                <i class="nav-main-link-icon si si-graduation"></i>
                                <span class="nav-main-link-name">JobNumber</span>
                            </a>
                        </li>
                        <li class="nav-main-heading">More</li>
                        <li class="nav-main-item open">
                            <a class="nav-main-link{{ request()->is('image*') ? ' active' : '' }}" href="{{url('/image')}}">
                    ...
                    <div>
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn btn-dual" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="d-none d-sm-inline-block">{{ Session::get('admin')->email }}</span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right p-0" aria-labelledby="page-header-user-dropdown">
                                ...
                                <div class="p-2">
                                    <a class="dropdown-item" href="javascript:onEditProfile();">
...
{{--                        </button>--}}
                ...
                <div class="content py-0">
                    <div class="row font-size-sm">
                        <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-right">
                            Crafted with <i class="fa fa-heart text-danger"></i> by <a class="font-w600" href="#" >Sandy</a>
                        </div>
                        <div class="col-sm-6 order-sm-1 text-center text-sm-left">
                            <a class="font-w600" href="#">Earle</a> &copy; <span data-toggle="year-copy">2019</span>
                        </div>
                    </div>
                </div>
            </footer>
        ...
        <!-- Eidt Modal -->
        <div class="modal fade" id="profile-modal" tabindex="-1" role="dialog" aria-labelledby="modal-block-fadein" aria-hidden="true">
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content block-content-full text-right bg-light">
                            ...
                            <button type="button" class="btn btn-sm btn-primary" id="save-profile">Save</button>
                        </div>
                    </div>
                </div>
            </div>
